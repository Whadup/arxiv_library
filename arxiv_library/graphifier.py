...
if __name__ == '__main__':
    ...
    with open(os.path.join(args.dataset_path, 'arxiv_citations_A.txt'), 'w') as file:
    ...
    with open(os.path.join(args.dataset_path, 'arxiv_citations_node_labels.txt'), 'w') as file:
        file.write('0\n' * graph.size())
    ...
    with open(os.path.join(args.dataset_path, 'arxiv_citations_graph_indicator.txt'), 'w') as file:
        file.write('0\n' * graph.size())
    ...
    with open(os.path.join(args.dataset_path, 'arxiv_citations_graph_labels.txt'), 'w') as file:
    ...
    with open(os.path.join(args.dataset_path, 'arxiv_citations_node_attributes.txt'), 'w') as file:
